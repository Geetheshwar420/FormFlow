...
function Dashboard() {
  ...
  const { data: ownedFormsData, isLoading: isOwnedLoading } = useCollection<Omit<Form, 'id'>>(ownedFormsRef);
  ...
  const { data: sharedFormsData, isLoading: isSharedLoading } = useCollection<Omit<Form, 'id'>>(sharedFormsQuery);
