    ...
    <div className="min-h-screen w-full lg:grid lg:grid-cols-2">
      <div className="hidden lg:flex flex-col items-start justify-center bg-muted p-12 relative">
        ...
        <div className="max-w-md">
            <h1 className="text-4xl font-bold font-headline mb-4">Welcome Back!</h1>
            <p className="text-muted-foreground text-lg">
                Build beautiful forms and surveys in seconds. Analyze responses in real-time and make data-driven decisions.
            </p>
        </div>
      </div>
